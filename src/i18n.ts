...
const STRINGS: Record<string, Dict> = {
  zh: {
    ...
    'opt.langAuto': '自动',
    'set.ttsEngine': '发音引擎',
    'opt.ttsSystem': '系统优先，无系统语音时自动离线',
    'opt.ttsKokoro': '始终使用离线神经网络（约 80–100 MB）',
  ...
  en: {
    ...
    'opt.ttsSystem': 'System first, offline fallback',
    'opt.ttsKokoro': 'Always offline neural (~80–100 MB)',
